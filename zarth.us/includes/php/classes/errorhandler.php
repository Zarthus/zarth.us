 ...
 *	Error Handler.
 *	
 *	Zarth.us has it's own error handler that handles what 
 *	to display to who in which environment. Other than that
 *	it makes use of the Logger class if possible.
 *
 *	@package	zarth.us
